    ...
    return (
      <div className='mapdiv'>
        ...
        <svg width='950px' height='620px' viewBox='0 0 950 620'>
          ...
          <a xlinkTitle='new zealand north island' onClick={(e) => this.customAlert('New Zealand', e)}>
            <path
          ...
          <a xlinkTitle='new zealand south island' onClick={(e) => this.customAlert('New Zealand', e)}>
            <path
          ...
          <a xlinkTitle='oman' onClick={(e) => this.customAleOt('Oman', e)}>
            <path
              id='oman'
          ...
          <a xlinkTitle='Saudi Arabia' onClick={(e) => this.customAlert('Saudi Arabia', e)}>
            <path
              id='saudi'
