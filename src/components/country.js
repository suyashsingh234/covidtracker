    ...
    return (
      <div className='mapdiv'>
        ...
        <svg width='950px' height='620px' viewBox='0 0 950 620'>
          ...
          <a xlinkTitle='kalimantan' onClick={(e) => this.customAlert('kalimantan', e)}>
            <path
              id='kalimantan'
          ...
          <a xlinkTitle='papua new guinea' onClick={(e) => this.customAlert('papua new guinea', e)}>
            <path
              id='papua new guinea'
          ...
          <a xlinkTitle='mexico' onClick={(e) => this.customAlert('mexico', e)}>
            <path
              id='mexico'
          ...
          <a xlinkTitle='estonia' onClick={(e) => this.customAlert('estonia', e)}>
            <path
              id='estonia'
              d='M517.77,143.66l-5.6-0.2l-3.55,2.17l-0.05,1.61l2.3,2.17l7.15,1.21L517.77,143.66L517.77,143.66z'
            />
          </a>
          <a xlinkTitle='algeria' onClick={(e) => this.customAlert('algeria', e)}>
            <path
              id='algeria'
          ...
          <a xlinkTitle='morocco' onClick={(e) => this.customAlert('morocco', e)}>
            <path
              id='morocco'
          ...
          <a xlinkTitle='mauretania' onClick={(e) => this.customAlert('mauretania', e)}>
            <path
              id='mauretania'
          ...
          <a xlinkTitle='senegal' onClick={(e) => this.customAlert('senegal', e)}>
            <path
              id='senegal'
          ...
          <a xlinkTitle='sierra leone' onClick={(e) => this.customAlert('sierra leone', e)}>
            <path
              id='sierra leone'
              d='M413.93,313.13l5.65,5.46l4.03-4.89l-2.52-3.95l-3.47,0.35L413.93,313.13L413.93,313.13z'
            />
          </a>
          <a xlinkTitle='liberia' onClick={(e) => this.customAlert('liberia', e)}>
            <path
              id='liberia'
              d='M420.17,319.19l10.98,7.34l-0.26-5.56l-3.32-3.91l-3.24-2.87L420.17,319.19L420.17,319.19z'
            />
          </a>
          <a xlinkTitle='ivoire' onClick={(e) => this.customAlert('ivoire', e)}>
            <path
              id='ivoire'
          ...
          <a xlinkTitle='mali' onClick={(e) => this.customAlert('mali', e)}>
            <path
              id='mali'
          ...
          <a xlinkTitle='burkina' onClick={(e) => this.customAlert('burkina', e)}>
            <path
              id='burkina'
          ...
          <a xlinkTitle='niger' onClick={(e) => this.customAlert('niger', e)}>
            <path
              id='niger'
          ...
          <a xlinkTitle='tunisia' onClick={(e) => this.customAlert('tunisia', e)}>
            <path
              id='tunisia'
          ...
          <a xlinkTitle='libya' onClick={(e) => this.customAlert('libya', e)}>
            <path
              id='libya'
          ...
          <a xlinkTitle='egypt' onClick={(e) => this.customAlert('egypt', e)}>
            <path
              id='egypt'
          ...
          <a xlinkTitle='chad' onClick={(e) => this.customAlert('chad', e)}>
            <path
              id='chad'
          ...
          <a xlinkTitle='south sudan' onClick={(e) => this.customAlert('south sudan', e)}>
            <path
          ...
          <a xlinkTitle='sudan' onClick={(e) => this.customAlert('sudan', e)}>
            <path
          ...
          <a xlinkTitle='cameroon' onClick={(e) => this.customAlert('cameroon', e)}>
            <path
              id='cameroon'
          ...
          <a xlinkTitle='somaliland' onClick={(e) => this.customAlert('somaliland', e)}>
            <path
              id='somaliland'
          ...
          <a xlinkTitle='soqotra' onClick={(e) => this.customAlert('soqotra', e)}>
            <path
              id='soqotra'
              d='M599.62,299.65l2.13,2.38l2.88-1.74l1.04-0.35l-1.32-1.28l-2.53,0.75L599.62,299.65L599.62,299.65z'
            />
          </a>
          <a xlinkTitle='somalia' onClick={(e) => this.customAlert('somalia', e)}>
            <path
              id='somalia'
          ...
          <a xlinkTitle='centrafrique' onClick={(e) => this.customAlert('centrafrique', e)}>
            <path
              id='centrafrique'
          ...
          <a xlinkTitle='equatorial guinea' onClick={(e) => this.customAlert('equatorial guinea', e)}>
            <path
              id='equatorial guinea'
              d='M480.99,332.69l-0.06,1.39l4.54,0.23l-0.06-1.57L480.99,332.69L480.99,332.69z'
            />
          </a>
          <a xlinkTitle='congo' onClick={(e) => this.customAlert('congo', e)}>
            <path
              id='congo'
          ...
          <a xlinkTitle='cabinda' onClick={(e) => this.customAlert('cabinda', e)}>
            <path
              id='cabinda'
              d='M486.55,353.23l1.74,2.26l2.25-2.13l-0.66-2.21l-0.56-0.04L486.55,353.23L486.55,353.23z'
            />
          </a>
          <a xlinkTitle='drc' onClick={(e) => this.customAlert('drc', e)}>
            <path
              id='drc'
          ...
          <a xlinkTitle='kenya' onClick={(e) => this.customAlert('kenya', e)}>
            <path
              id='kenya'
          ...
          <a xlinkTitle='tanzania' onClick={(e) => this.customAlert('tanzania', e)}>
            <path
              id='tanzania'
          ...
          <a xlinkTitle='zambia' onClick={(e) => this.customAlert('zambia', e)}>
            <path
              id='zambia'
          ...
          <a xlinkTitle='angola' onClick={(e) => this.customAlert('angola', e)}>
            <path
              id='angola'
          ...
          <a xlinkTitle='malawi' onClick={(e) => this.customAlert('malawi', e)}>
            <path
              id='malawi'
          ...
          <a xlinkTitle='mozambique' onClick={(e) => this.customAlert('mozambique', e)}>
            <path
              id='mozambique'
          ...
          <a xlinkTitle='zimbabwe' onClick={(e) => this.customAlert('zimbabwe', e)}>
            <path
              id='zimbabwe'
          ...
          <a xlinkTitle='namibia' onClick={(e) => this.customAlert('namibia', e)}>
            <path
              id='namibia'
          ...
          <a xlinkTitle='botswana' onClick={(e) => this.customAlert('botswana', e)}>
            <path
              id='botswana'
          ...
          <a xlinkTitle='swaziland' onClick={(e) => this.customAlert('swaziland', e)}>
            <path
              id='swaziland'
              d='M540.87,414l-2.51,0.42l-1.08,2.95l1.92,1.75h2.33l1.97-2.83L540.87,414L540.87,414z'
            />
          </a>
          <a xlinkTitle='lesotho' onClick={(e) => this.customAlert('lesotho', e)}>
            <path
              id='lesotho'
          ...
          <a xlinkTitle='south africa' onClick={(e) => this.customAlert('south africa', e)}>
            <path
              id='south africa'
              d='M534.16,403.63l-7.9,7.3l-1.88,4.51l-6.26-0.78l-5.21,4.63l-3.46-0.34l0.28-6.4l-1.23-0.43l-0.86,13.09l-6.14-0.06l-1.85-2.18l-2.71-0.03l2.47,7.09l4.41,4.17l-3.15,3.67l2.04,4.6l4.72,1.8l3.76-3.2l10.77,0.06l0.77-0.96l4.78-0.84l16.17-16.1l-0.06-5.07l-1.73,2.24h-2.59l-3.15-2.64l1.6-3.98l2.75-0.56l-0.25-8.18L534.16,403.63L534.16,403.63z M530.37,422.13l1.51-0.06l2.45,2.66l-0.07,3.08l-2.87,1.45l-0.18,1.02l-4.38,0.05l-1.37-3.3l1.25-2.42L530.37,422.13L530.37,422.13z'
            />
          </a>
          <a xlinkTitle='greenland' onClick={(e) => this.customAlert('greenland', e)}>
            <path
              id='greenland'
          ...
          <a xlinkTitle='disko' onClick={(e) => this.customAlert('disko', e)}>
            <path
              id='disko'
              d='M342.89,92.49l1.63,2.45l-0.82,2.99h-1.63l-2.18-2.45l0.54-1.9L342.89,92.49L342.89,92.49z'
            />
          </a>
          <a xlinkTitle='milne' onClick={(e) => this.customAlert('milne', e)}>
            <path
              id='milne'
              d='M410.87,85.69l4.62,1.36l-0.27,3.81l-4.89-2.45l-1.09-1.36L410.87,85.69L410.87,85.69z'
            />
          </a>
          <a xlinkTitle='east antarctica' onClick={(e) => this.customAlert('east antarctica', e)}>
            <path
              id='east antarctica'
          ...
          <a xlinkTitle='antarctic peninsula' onClick={(e) => this.customAlert('antarctic peninsula', e)}>
            <path
          ...
          <a xlinkTitle='thurston' onClick={(e) => this.customAlert('thurston', e)}>
            <path
              id='thurston'
          ...
          <a xlinkTitle='alexander' onClick={(e) => this.customAlert('alexander', e)}>
            <path
              id='alexander'
          ...
          <a xlinkTitle='tasmania' onClick={(e) => this.customAlert('tasmania', e)}>
            <path
              id='tasmania'
              d='M825.74,496.26l-1.77,7.15l0.35,5l5.32-0.36l6.03-9.29L825.74,496.26L825.74,496.26z'
            />
          </a>
          <a xlinkTitle='new zealand north island' onClick={(e) => this.customAlert('new zealand north island', e)}>
            <path
          ...
          <a xlinkTitle='new zealand south island' onClick={(e) => this.customAlert('new zealand south island', e)}>
            <path
          ...
          <a xlinkTitle='new caledonia' onClick={(e) => this.customAlert('new caledonia', e)}>
            <path
              id='new caledonia'
              d='M906.64,420.47l-0.35,1.79l4.61,6.43l2.48,1.07l0.35-2.5L906.64,420.47L906.64,420.47z'
            />
          </a>
          <a xlinkTitle='sumatra' onClick={(e) => this.customAlert('sumatra', e)}>
            <path
              id='sumatra'
          ...
          <a xlinkTitle='east malaysia' onClick={(e) => this.customAlert('east malaysia', e)}>
            <path
              id='east malaysia'
          ...
          <a xlinkTitle='brunei' onClick={(e) => this.customAlert('brunei', e)}>
            <path
              id='brunei'
              d='M779.77,319.25l-2.88,3.49l2.36,0.74l1.33-1.86L779.77,319.25L779.77,319.25z'
            />
          </a>
          <a xlinkTitle='sulawesi' onClick={(e) => this.customAlert('sulawesi', e)}>
            <path
              id='sulawesi'
          ...
          <a xlinkTitle='java' onClick={(e) => this.customAlert('java', e)}>
            <path
              id='java'
          ...
          <a xlinkTitle='luzon' onClick={(e) => this.customAlert('luzon', e)}>
            <path
              id='luzon'
          ...
          <a xlinkTitle='shikoku' onClick={(e) => this.customAlert('shikoku', e)}>
            <path
              id='shikoku'
              d='M812.03,213.15l-2.77,2.6l-0.1,2.99l0.67,0.87l3.73-3.18l-0.29-3.18L812.03,213.15L812.03,213.15z'
            />
          </a>
          <a xlinkTitle='honshu' onClick={(e) => this.customAlert('honshu', e)}>
            <path
              id='honshu'
          ...
          <a xlinkTitle='hokkaido' onClick={(e) => this.customAlert('hokkaido', e)}>
            <path
              id='hokkaido'
          ...
          <a xlinkTitle='St. lawrence island west' onClick={(e) => this.customAlert('St. lawrence island west', e)}>
            <path
              id='st. lawrence island west'
              d='M69.17,53.35l3.46,6.47l2.22-0.5v-2.24L69.17,53.35L69.17,53.35z'
            />
          </a>
          <a xlinkTitle='alaska' onClick={(e) => this.customAlert('alaska', e)}>
            <path
              id='alaska'
          ...
          <a xlinkTitle='chukotka' onClick={(e) => this.customAlert('chukotka', e)}>
            <path
              id='chukotka'
          ...
          <a xlinkTitle='domincan republic' onClick={(e) => this.customAlert('domincan republic', e)}>
            <path
          ...
          <a xlinkTitle='haiti' onClick={(e) => this.customAlert('haiti', e)}>
            <path
              id='haiti'
          ...
          <a xlinkTitle='falklands west' onClick={(e) => this.customAlert('falklands west', e)}>
            <path
              id='falklands west'
              d='M307.95,508.18l-2.63-0.29l-2.62,1.76l1.9,2.06L307.95,508.18L307.95,508.18z'
            />
          </a>
          <a xlinkTitle='falklands east' onClick={(e) => this.customAlert('falklands east', e)}>
            <path
              id='falklands east'
              d='M310.57,506.86l-0.87,2.79l-2.48,2.2l0.15,0.73l4.23-1.62l1.75-2.2L310.57,506.86L310.57,506.86z'
            />
          </a>
          <a xlinkTitle='iceland' onClick={(e) => this.customAlert('iceland', e)}>
            <path
              id='iceland'
          ...
          <a xlinkTitle='spitsbergen' onClick={(e) => this.customAlert('spitsbergen', e)}>
            <path
              id='spitsbergen'
          ...
          <a xlinkTitle='nordaustlandet' onClick={(e) => this.customAlert('nordaustlandet', e)}>
            <path
              id='nordaustlandet'
          ...
          <a xlinkTitle='novaya zemlya south' onClick={(e) => this.customAlert('novaya zemlya south', e)}>
            <path
          ...
          <a xlinkTitle='komsomolets' onClick={(e) => this.customAlert('komsomolets', e)}>
            <path
              id='komsomolets'
              d='M634.95,18.15l-2.24-1.39h-2.58l-0.52,1.56l-2.75,1.56l-2.07,0.69l-0.34,2.08l4.82,0.35L634.95,18.15L634.95,18.15z'
            />
          </a>
          <a xlinkTitle='october' onClick={(e) => this.customAlert('october', e)}>
            <path
              id='october'
          ...
          <a xlinkTitle='bolshevik' onClick={(e) => this.customAlert('bolshevik', e)}>
            <path
              id='bolshevik'
              d='M645.28,20.58l1.21,4.86l1.89,4.51l2.07-3.64l3.96-0.87v-2.6l-2.58-1.91L645.28,20.58L645.28,20.58z'
            />
          </a>
          <a xlinkTitle='kotelny' onClick={(e) => this.customAlert('kotelny', e)}>
            <path
              id='kotelny'
          ...
          <a xlinkTitle='cuba' onClick={(e) => this.customAlert('cuba', e)}>
            <path
              id='cuba'
          ...
          <a xlinkTitle='prince patrick' onClick={(e) => this.customAlert('prince patrick', e)}>
            <path
              id='prince patrick'
          ...
          <a xlinkTitle='eglinton' onClick={(e) => this.customAlert('eglinton', e)}>
            <path
              id='eglinton'
          ...
          <a xlinkTitle='victoria' onClick={(e) => this.customAlert('victoria', e)}>
            <path
              id='victoria'
          ...
          <a xlinkTitle='prince of wales' onClick={(e) => this.customAlert('prince of wales', e)}>
            <path
              id='prince of wales'
          ...
          <a xlinkTitle='baffin' onClick={(e) => this.customAlert('baffin', e)}>
            <path
              id='baffin'
              d='M282.88,61.59L278,61.14l-5.76,2.23l-3.1,4.24l0.89,11.62l9.53,0.45l9.09,4.47l6.43,7.37l4.88-0.22l-1.33,6.92l-4.43,7.37l-4.88,2.23l-3.55-0.67l-1.77-1.56l-2.66,3.57l1.11,3.57l3.77,0.22l4.66-2.23l3.99,10.28l9.98,6.48l6.87-8.71l-5.76-9.38l3.33-3.8l4.66,7.82l8.42-7.37l-1.55-3.35l-5.76,1.79l-3.99-10.95l3.77-6.25l-7.54-8.04l-4.21,2.9l-3.99-8.71l-8.42,1.12l-2.22-10.5l-6.87,4.69l-0.67,5.81h-3.77l0.44-5.14L282.88,61.59L282.88,61.59z'
            />
          </a>
          <a xlinkTitle='bylot' onClick={(e) => this.customAlert('bylot', e)}>
            <path
              id='bylot'
              d='M292.86,65.61l-1.77,1.79l1.55,2.46l7.32,0.89l-4.66-4.92L292.86,65.61L292.86,65.61z'
            />
          </a>
          <a xlinkTitle='ellesmere' onClick={(e) => this.customAlert('ellesmere', e)}>
            <path
              id='ellesmere'
          ...
          <a xlinkTitle='southhampton' onClick={(e) => this.customAlert('southhampton', e)}>
            <path
              id='southhampton'
              d='M266.01,101.85l-4.23,5.32l-0.26,5.86l3.7-2.13h4.49l3.17,2.93l2.91-2.4L266.01,101.85L266.01,101.85z'
            />
          </a>
          <a xlinkTitle='newfoundland' onClick={(e) => this.customAlert('newfoundland', e)}>
            <path
              id='newfoundland'
          ...
          <a xlinkTitle='canada' onClick={(e) => this.customAlert('canada', e)}>
            <path
              id='canada'
          ...
          <a xlinkTitle='haida gwaii' onClick={(e) => this.customAlert('haida gwaii', e)}>
            <path
              id='haida gwaii'
          ...
          <a xlinkTitle='vancouver' onClick={(e) => this.customAlert('vancouver', e)}>
            <path
              id='vancouver'
              d='M139.45,147.95l-1.53,0.6l2.81,3.26l0.68,3.86l2.81,3l2.38-0.43v-3.94l-2.89-1.8L139.45,147.95L139.45,147.95z'
            />
          </a>
          <a xlinkTitle='guatemala' onClick={(e) => this.customAlert('guatemala', e)}>
            <path
              id='guatemala'
          ...
          <a xlinkTitle='honduras' onClick={(e) => this.customAlert('honduras', e)}>
            <path
              id='honduras'
          ...
          <a xlinkTitle='colombia' onClick={(e) => this.customAlert('colombia', e)}>
            <path
              id='colombia'
          ...
          <a xlinkTitle='venezuela' onClick={(e) => this.customAlert('venezuela', e)}>
            <path
              id='venezuela'
          ...
          <a xlinkTitle='guyana' onClick={(e) => this.customAlert('guyana', e)}>
            <path
              id='guyana'
          ...
          <a xlinkTitle='suriname' onClick={(e) => this.customAlert('suriname', e)}>
            <path
              id='suriname'
          ...
          <a xlinkTitle='guyane' onClick={(e) => this.customAlert('guyane', e)}>
            <path
              id='guyane'
              d='M302.13,321.8l5.85,3.65l-3.06,6.08l-1.11,1.4l-3.25-1.87l0.09-6.55L302.13,321.8L302.13,321.8z'
            />
          </a>
          <a xlinkTitle='ecuador' onClick={(e) => this.customAlert('ecuador', e)}>
            <path
              id='ecuador'
          ...
          <a xlinkTitle='peru' onClick={(e) => this.customAlert('peru', e)}>
            <path
              id='peru'
          ...
          <a xlinkTitle='bolivia' onClick={(e) => this.customAlert('bolivia', e)}>
            <path
              id='bolivia'
          ...
          <a xlinkTitle='paraguay' onClick={(e) => this.customAlert('paraguay', e)}>
            <path
              id='paraguay'
          ...
          <a xlinkTitle='uruguay' onClick={(e) => this.customAlert('uruguay', e)}>
            <path
              id='uruguay'
              d='M300.36,431.93l-2.05,2.19l0.85,11.78l6.44,1.87l8.19-8.21L300.36,431.93L300.36,431.93z'
            />
          </a>
          <a xlinkTitle='argentina' onClick={(e) => this.customAlert('argentina', e)}>
            <path
              id='argentina'
          ...
          <a xlinkTitle='tierra del fuego chile' onClick={(e) => this.customAlert('tierra del fuego chile', e)}>
            <path
              id='tierra del fuego chile'
              d='M285.04,514.1l-4.27,9.38l7.37,0.78l0.13-6.25L285.04,514.1L285.04,514.1z'
            />
          </a>
          <a xlinkTitle='tierra del fuego argentina' onClick={(e) => this.customAlert('tierra del fuego argentina', e)}>
            <path
              id='tierra del fuego argentina'
              d='M288.92,518.79l0.26,5.73l4.4-0.39l3.75-2.48l-6.34-1.3L288.92,518.79L288.92,518.79z'
            />
          </a>
          <a xlinkTitle='chile' onClick={(e) => this.customAlert('chile', e)}>
            <path
              id='chile'
          ...
          <a xlinkTitle='chiloe' onClick={(e) => this.customAlert('chiloe', e)}>
            <path
              id='chiloe'
              d='M262.28,475.14l-1.29,1.95l0.65,3.39l1.29,0.13l0.65-4.3L262.28,475.14L262.28,475.14z'
            />
          </a>
          <a xlinkTitle='brazil' onClick={(e) => this.customAlert('brazil', e)}>
            <path
              id='brazil'
          ...
          <a xlinkTitle='belize' onClick={(e) => this.customAlert('belize', e)}>
            <path
              id='belize'
              d='M204.56,282.4l-0.05,3.65h0.84l2.86-5.34h-1.94L204.56,282.4L204.56,282.4z'
            />
          </a>
          <a xlinkTitle='russia' onClick={(e) => this.customAlert('russia', e)}>
            <path
              id='russia'
          ...
          <a xlinkTitle='mongolia' onClick={(e) => this.customAlert('mongolia', e)}>
            <path
              id='mongolia'
              d='M673.8,170.17l5.82-7.72l6.99,3.23l4.75,1.27l5.82-5.34l-3.95-2.91l2.6-3.67l7.76,2.74l2.69,4.41l4.86,0.13l2.54-1.89l5.23-0.21l1.14,1.94l8.69,0.44l5.5-5.61l7.61,0.8l-0.44,7.64l3.33,0.76l4.09-1.86l4.33,2.14l-0.1,1.08l-3.14,0.09l-3.27,6.86l-2.54,0.25l-9.88,12.91l-10.09,4.45l-6.31,0.49l-5.24-3.38l-6.7,3.58l-6.6-2.05l-1.87-4.79l-12.5-0.88l-6.4-10.85l-3.11-0.2L673.8,170.17L673.8,170.17z'
            />
          </a>
          <a xlinkTitle='north korea' onClick={(e) => this.customAlert('north korea', e)}>
            <path
              id='north korea'
          ...
          <a xlinkTitle='south korea' onClick={(e) => this.customAlert('south korea', e)}>
            <path
              id='south korea'
          ...
          <a xlinkTitle='kazakhstan' onClick={(e) => this.customAlert('kazakhstan', e)}>
            <path
              id='kazakhstan'
          ...
          <a xlinkTitle='turkmenistan' onClick={(e) => this.customAlert('turkmenistan', e)}>
            <path
              id='turkmenistan'
          ...
          <a xlinkTitle='uzbekistan' onClick={(e) => this.customAlert('uzbekistan', e)}>
            <path
              id='uzbekistan'
          ...
          <a xlinkTitle='tajikistan' onClick={(e) => this.customAlert('tajikistan', e)}>
            <path
              id='tajikistan'
          ...
          <a xlinkTitle='kirgizstan' onClick={(e) => this.customAlert('kirgizstan', e)}>
            <path
              id='kirgizstan'
          ...
          <a xlinkTitle='afghanistan' onClick={(e) => this.customAlert('afghanistan', e)}>
            <path
              id='afghanistan'
          ...
          <a xlinkTitle='pakistan' onClick={(e) => this.customAlert('pakistan', e)}>
            <path
              id='pakistan'
          ...
          <a xlinkTitle='malaysia' onClick={(e) => this.customAlert('malaysia', e)}>
            <path
              id='malaysia'
          ...
          <a xlinkTitle='cambodia' onClick={(e) => this.customAlert('cambodia', e)}>
            <path
              id='cambodia'
          ...
          <a xlinkTitle='laos' onClick={(e) => this.customAlert('laos', e)}>
            <path
              id='laos'
          ...
          <a xlinkTitle='vietnam' onClick={(e) => this.customAlert('vietnam', e)}>
            <path
              id='vietnam'
          ...
          <a xlinkTitle='iran' onClick={(e) => this.customAlert('iran', e)}>
            <path
              id='iran'
          ...
          <a xlinkTitle='turkey' onClick={(e) => this.customAlert('turkey', e)}>
            <path
              id='turkey'
          ...
          <a xlinkTitle='yemen' onClick={(e) => this.customAlert('yemen', e)}>
            <path
              id='yemen'
          ...
          <a xlinkTitle='oman' onClick={(e) => this.customAlert('oman', e)}>
            <path
              id='oman'
          ...
          <a xlinkTitle='syria' onClick={(e) => this.customAlert('syria', e)}>
            <path
              id='syria'
          ...
          <a xlinkTitle='iraq' onClick={(e) => this.customAlert('iraq', e)}>
            <path
              id='iraq'
          ...
          <a xlinkTitle='jordan' onClick={(e) => this.customAlert('jordan', e)}>
            <path
              id='jordan'
          ...
          <a xlinkTitle='ulster' onClick={(e) => this.customAlert('ulster', e)}>
            <path
              id='ulster'
              d='M438.42,161.47l-3.3,0.37l-0.18,2.96l2.2,1.48l2.38-0.55l0.92-1.66L438.42,161.47L438.42,161.47z'
            />
          </a>
          <a xlinkTitle='ireland' onClick={(e) => this.customAlert('ireland', e)}>
            <path
              id='ireland'
          ...
          <a xlinkTitle='sweden' onClick={(e) => this.customAlert('sweden', e)}>
            <path
              id='sweden'
          ...
          <a xlinkTitle='finland' onClick={(e) => this.customAlert('finland', e)}>
            <path
              id='finland'
          ...
          <a xlinkTitle='belarus' onClick={(e) => this.customAlert('belarus', e)}>
            <path
              id='belarus'
          ...
          <a xlinkTitle='poland' onClick={(e) => this.customAlert('poland', e)}>
            <path
              id='poland'
          ...
          <a xlinkTitle='portugal' onClick={(e) => this.customAlert('portugal', e)}>
            <path
              id='portugal'
          ...
          <a xlinkTitle='netherlands' onClick={(e) => this.customAlert('netherlands', e)}>
            <path
              id='netherlands'
          ...
          <a xlinkTitle='belgium' onClick={(e) => this.customAlert('belgium', e)}>
            <path
              id='belgium'
          ...
          <a xlinkTitle='denmark' onClick={(e) => this.customAlert('denmark', e)}>
            <path
              id='denmark'
          ...
          <a xlinkTitle='sjælland' onClick={(e) => this.customAlert('sjælland', e)}>
            <path
              id='sjælland'
              d='M481.44,159.64l-0.93-0.04l-1.22,1.12l0.15,1.75l2.89,0.08l0.15-1.98L481.44,159.64L481.44,159.64z'
            />
          </a>
          <a xlinkTitle='gotland' onClick={(e) => this.customAlert('gotland', e)}>
            <path
              id='gotland'
              d='M498.49,150.17l-2.11,1.67l1.06,2.45l1.87-1.82L498.49,150.17L498.49,150.17z'
            />
          </a>
          <a xlinkTitle='switzerland' onClick={(e) => this.customAlert('switzerland', e)}>
            <path
              id='switzerland'
          ...
          <a xlinkTitle='austria' onClick={(e) => this.customAlert('austria', e)}>
            <path
              id='austria'
          ...
          <a xlinkTitle='hungary' onClick={(e) => this.customAlert('hungary', e)}>
            <path
              id='hungary'
          ...
          <a xlinkTitle='slovenia' onClick={(e) => this.customAlert('slovenia', e)}>
            <path
              id='slovenia'
              d='M494.8,191.99l-2.54,1.52l-4.74,1.04l0.95,2.74l3.32,0.04l3.06-2.56L494.8,191.99L494.8,191.99z'
            />
          </a>
          <a xlinkTitle='croatia' onClick={(e) => this.customAlert('croatia', e)}>
            <path
              id='croatia'
          ...
          <a xlinkTitle='bosnia' onClick={(e) => this.customAlert('bosnia', e)}>
            <path
              id='bosnia'
          ...
          <a xlinkTitle='moldova' onClick={(e) => this.customAlert('moldova', e)}>
            <path
              id='moldova'
              d='M520.75,187.71l3.1,4.77l-0.26,2.7l1.11,0.05l2.63-4.45l-3.16-3.92l-1.79-0.74L520.75,187.71L520.75,187.71z'
            />
          </a>
          <a xlinkTitle='romania' onClick={(e) => this.customAlert('romania', e)}>
            <path
              id='romania'
          ...
          <a xlinkTitle='montenegro' onClick={(e) => this.customAlert('montenegro', e)}>
            <path
          ...
          <a xlinkTitle='serbia' onClick={(e) => this.customAlert('serbia', e)}>
            <path
          ...
          <a xlinkTitle='bulgaria' onClick={(e) => this.customAlert('bulgaria', e)}>
            <path
              id='bulgaria'
          ...
          <a xlinkTitle='thrace' onClick={(e) => this.customAlert('thrace', e)}>
            <path
              id='thrace'
              d='M523.02,209.7l-0.16,3.55l3.1-0.95l1.42-0.95l-0.42-1.54l-1.47-1.17L523.02,209.7L523.02,209.7z'
            />
          </a>
          <a xlinkTitle='crete' onClick={(e) => this.customAlert('crete', e)}>
            <path
              id='crete'
